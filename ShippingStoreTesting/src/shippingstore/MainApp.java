 ...
 * Date: 9/20/17
 * The Driver reads in data(packages) from a file and 
 * writes data from user input once the program terminates.
 * The user adds, removes and views the products to and 
